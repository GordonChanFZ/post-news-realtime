...
from channel.wxpusher import WxpusherBot
...
if __name__=='__main__':
    finance=FinanceBot(app_token='AT_djGMF6vWGdTZDyaXBLXFVPtU3HAxtaFD', service='7*24news', interval=300)
    finance.post()