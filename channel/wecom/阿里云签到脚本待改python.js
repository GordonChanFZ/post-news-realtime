...
function sleep(d) {
 ...
 const url ="https://qyapi.weixin.qq.com/cgi-bin/webhook/send?key=3c3568b9-0402-4953-bb08-0dd0abafa0ce"
            ...
            if (customEmailResult == "是") { // 如果“是否自定义邮箱”为“是”
              ...
              if (emailConfigured === "是") { // 如果配置了自定义邮箱
                ...
                mailer = SMTP.login({
                  host: "smtp.163.com",
                  port: 465,
                  username: "gordonchanfz@outlook.com",
                  password: "Gordonchan@4162",
                  secure: true
                });
                mailer.send({
